  ...
  return (
    <div className="aspect-[9/16] h-full flex flex-col items-start justify-between pt-10 bg-[#f7f8f9] p-6">
      <div className="top w-full">
        <p className="text-3xl font-medium max-w-3/5 mb-8">
      ...
      <button
        ...
        className={`text-white text-[15px] font-semibold w-full text-center bg-[#6c25ff] transition-all duration-300 hover:bg-[#5d0ec0] p-2 rounded-md mb-2 ${
